...
A vector index can be created on a vector column to provide appropriate searches for vectors that are “close” to a given vector according to one of the distance metrics described in the section ‎3 above. Regatta supports two types of vector indexes: HNSW and IVFFLAT. 
