...
./cluster_readiness_orchestrator.sh -i hosts.json -r /tmp/cluster_ready -k <path_to_ssh_key> -u <user_name> 
...
| -i, --inventory       | Inventory file with host list (text format) or JSON format with hosts and devices             |
...
| --gcp                 | Use internal IPs for interconnectivity.<br />Usec for hosts in VPC and external orchestrator. |
