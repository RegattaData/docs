...
The recommended way to distribute the RPMs to each server is to upload all RPMs to one of the dedicated cluster servers, and `scp` the RPMs from that server to the others according to the distribution plan.
