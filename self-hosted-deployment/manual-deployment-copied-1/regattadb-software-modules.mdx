...
RegattaDB consists of six software modules that together form the Regatta database system. Each deployment includes a combination of these modules, distributed across one or more nodes. These nodes may be physical, VMs or containers.
