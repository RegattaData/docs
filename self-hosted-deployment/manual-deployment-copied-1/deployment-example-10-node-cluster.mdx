...
- **Node01** – Hosts the **SM**, **GDD**, **DCM**, and **Sequencer** modules, along with its local **SNA** and **RDB** modules. The node hosting the **SM** is commonly referred to as the _Management Node_.
...
- **Node01**
  - Internal: `10.0.0.1`
  - External: `192.168.1.101` ~~(Management Node)~~
- **Node02–Node10**  
