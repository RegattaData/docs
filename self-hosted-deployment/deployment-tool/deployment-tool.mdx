...
Regatta offers a deployment tool that sets up the Regatta cluster with minimal user input. This tool, formally named the Regatta Deployment Tool (RDT), follows the same procedure described in the manual installation process using the recommended configuration.
