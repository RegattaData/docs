...
Most parameters have predefined values which will  be explained later in this page. The parameters in the JSON file will determine the way the data will be collected by the collect data script.
