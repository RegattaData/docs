...
To deploy **demo-small**, follow the steps described in Creating a Cluster, select the **Small** cluster capacity this time, but this time switch on the **Deploy Demo Data** button. Repeat the same steps for **demo-medium** but this time select the **Medium** type.\
...
For **demo-small** there are 3 nodes in the cluster, and for **demo-medium** there are 10 nodes (though you will need to scroll down to see the 10th one).
