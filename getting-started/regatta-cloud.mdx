<<<<<<< Updated upstream:getting-started/regatta-cloud.mdx
---
...
The Regatta Cloud is an easy way to get you started. In the follwoing sections we will guide you on how to access Regatta cloud, deploy a Regatta database, and access it using the WebCLI interface.
...
If this is not the case, please reach out to Regatta support.
>>>>>>> Stashed changes:getting-started/regatta-cloud/regatta-cloud.mdx
