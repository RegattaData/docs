...
One of the most important features of the Regatta Database is its linear scaling capability. The performance delivered grows lineraly with the size of the cluster for both OLTP and OLAP.  
