...
<Note>
  This example assumes you already downloaded and installed the [**Regatta TypeORM package**](/drivers-and-clients/javascript/install-your-javascript-client) (`typeorm-regatta`) and the [**Node.js driver**](/drivers-and-clients/javascript/install-your-javascript-client) (`node-regatta`) locally. If you installed them with `npm install path/to/*.tgz`, update the dependency versions accordingly instead of using `file:`.
</Note>
