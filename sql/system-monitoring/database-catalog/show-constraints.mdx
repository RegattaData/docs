...
This view has a row for every constraint in every table in the database, except for NULL constraints. Those are
presented as the column `IS_NULLABLE` at SHOW COLUMNS view.
