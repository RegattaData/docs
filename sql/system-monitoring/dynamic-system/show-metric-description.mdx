...
| :---------- | :-------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| METRIC_NAME | `VARCHAR(255)`  | <p> Unique short name for the metric. This is the filter column.</p>  <p> Note that some metrics appear in more than 1 view (in both SHOW DATABASE METRICS and SHOW MODULE METRICS).</p> |
...
| 3         | Inbound network throughput             | The inbound (from the Client to Regatta) network throughput in bytes per second                                                                       |
...
| 11        | Outbound network throughput            | The outbound (from Regatta to the Client) network throughput in bytes per second                                                                      |
