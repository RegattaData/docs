...
Row IDs can be returned from queries instead of table columns or expressions. For example: `SELECT ROWID FROM my\_table`. See the [SELECT](/sql/dql/select) command for more details.
