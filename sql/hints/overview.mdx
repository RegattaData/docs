...
INSERT, UPDATE, DELETE specify **_what_** should be done on the DB, not **_how_** it should be done. That leaves a lot of room for the query planner to build an optimal execution plan considering static and dynamic aspects of the query and the involved tables.
