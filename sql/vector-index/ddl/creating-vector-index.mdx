...
| m\_0 connectivity\_base | \[m, 64\] | The minimum between 2m and 64 | The maximum number of connections in layer 0. |
| ef\_construction | \[m\_0, 65535\] | max(m\_0, 40) | The size of the dynamic candidate list for constructing the graph. |
